  ...
  const handleTestCustom = async () => {
    ...
    try {
      ...
      if (err.response?.data?.message?.includes("token")) {
        ...
        setOutput(
          `Error: ${
            err.response?.data?.message || "Failed to test with custom input"
          }`
        );
      }
    } finally {
          ...
          <div className="bg-white rounded-2xl shadow-lg flex flex-col">
            <div className="p-6 border-b border-gray-200">
              ...
              <div className="text-sm text-gray-600 mb-2">
                Run Code will use custom input if provided, otherwise first test
                case input
              </div>
              <textarea
                value={code}
            ...
            <div className="flex-1 flex flex-col">
              <div className="p-6 border-b border-gray-200">
                ...
                <div
                  className={`rounded-lg p-4 h-32 overflow-y-auto font-mono text-sm ${
