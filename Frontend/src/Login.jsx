  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-400 via-purple-200 to-pink-100 font-sans">
      <div className="bg-white p-10 rounded-2xl shadow-xl w-96 flex flex-col items-center">
        ...
        >
          <h2 className="text-3xl font-extrabold mb-6 text-center text-blue-600 drop-shadow">
            Login
          </h2>
          {error && (
          ...
          <input
            ...
            className="w-full mb-4 p-3 border rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-blue-300"
            required
          />
          <input
            type="password"
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white py-3 rounded-full hover:bg-blue-700 font-semibold text-lg transition-all duration-150"
          >
