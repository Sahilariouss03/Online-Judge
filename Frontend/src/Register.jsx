  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-400 via-blue-200 to-pink-100 font-sans">
      <div className="bg-white p-10 rounded-2xl shadow-xl w-96 flex flex-col items-center">
        ...
        >
          <h2 className="text-3xl font-extrabold mb-6 text-center text-purple-600 drop-shadow">
            Register
          </h2>
          {error && (
          ...
          <input
            ...
            className="w-full mb-4 p-3 border rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-purple-300"
            required
          />
          <input
            type="text"
          ...
          <input
            ...
            className="w-full mb-6 p-3 border rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-purple-300"
            required
          />
          <button
            type="submit"
            className="w-full bg-purple-600 text-white py-3 rounded-full hover:bg-purple-700 font-semibold text-lg transition-all duration-150"
          >
            Register
          </button>
        </form>
